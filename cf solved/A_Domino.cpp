...
int main(){
    ...
    f(i,0,n){if(v[i][0]%2 != 0){q++;}}
    f(i,0,n){if(v[i][1]%2 != 0){w++;}}
    f(i,0,n){if(v[i][1]%2 != 0&& v[i][0]%2 != 0)e++;}
    if(q==w && w==e && q%2!=0){cout<<-1;}
    else if(q%2==0 && w%2==0){cout<<0;}
    else if(q%2==0 && w%2!=0){cout<<-1;}
    else if(q%2!=0 && w%2==0){cout<<-1;}
    else cout<<1;
}