...
int main(){
    ll x,y,n;
    cin>>x>>y>>n;
    if(n%6==1){cout<<mod_add(x,0,mod);}
    else if(n%6==2){cout<<mod_add(y,0,mod);}
    else if(n%6==3){cout<<mod_add(y-x,0,mod);}
    else if(n%6==4){cout<<mod_add(-x,0,mod);}
    else if(n%6==5){cout<<mod_add(-y,0,mod);}
    else {cout<<mod_add(x-y,0,mod);}
}