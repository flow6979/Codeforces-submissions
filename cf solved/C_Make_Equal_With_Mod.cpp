...
int main(){
    tc{
      ll n,q=0,w=0,e=0;
        ...
        f(i,0,n){cin>>v[i];}
        sort(v,v+n);
        // f(i,0,n){if(v[i]==0){q=1;break;}}
        f(i,0,n){if(v[i]==1){w=1;break;}}
        f(i,0,n-1){if(v[i+1]-v[i]==1){e=1;break;}}
        // if(q==1 && w==1){cout<<"NO"<<endl;}
        // else if(q==0 && w==1 && e==1){cout<<"NO"<<endl;}
        // else{cout<<"YES"<<endl;}
        if(w==0){cout<<"YES"<<endl;}
        else if(w==1 && e==0){cout<<"YES"<<endl;}
        else{cout<<"NO"<<endl;}
    }
}