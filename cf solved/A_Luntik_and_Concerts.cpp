...
int main(){
    tc{
        ...
        else {if(a==1 && b==1 && c==1)cout<<0<<endl;
                else if(a==0 && b==1 && c==1)cout<<1<<endl;
                else if(a==1 && b==0 && c==1)cout<<0<<endl;
                else if(a==1 && b==1 && c==0)cout<<1<<endl;
                else if(a==0 && b==0 && c==1)cout<<1<<endl;
                else if(a==1 && b==0 && c==0)cout<<1<<endl;
                else if(a==0 && b==1 && c==0)cout<<0<<endl;
